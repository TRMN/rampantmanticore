...
<div class="container" style="width: 75%;">
    <header class="row">
        <div class="col-sm-5 text-center vrt-ctr-parent"><img src="{{asset('images/rampantmanticore.svg')}} class="img-logo"></div>
