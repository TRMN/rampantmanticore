...
<head>
    ...
    <style>
        ...
        form, label {
            font-family: 'Incised 901 W01 Light' !important;
            color: #fff !important;
        }
        ...
        li {
            font-family: "Incised901 Ct BT" !important;
            color: #fff !important;
            background-color: #000 !important;
        }
        ...
        .button {
            background-color: #F3BB18 !important;
            color: #000 !important;
            font-family: "Incised 901 W01 Light" !important;
        }
        ...
        h1 {
            font-family: "Incised 901 W01 Bold" !important;
            color: #fff !important;
        }

        h2 {
            font-family: "Incised 901 W01 Bold Cd" !important;
            color: #fff !important;
        }

        h3, h4 {
            font-family: "Incised901 BT" !important;
            color: #fff !important;
        }
...
<div class="container" style="width: 75%;">
    <div class="row">
        <div class="col-md-6"><img src="{{asset('images/rampantmanticore.svg')}}" height="50%" width="50%"></div>
        <div class="col-md-6 text-center"><h2 class="rmgold prociono">The First Annual</h2>
            <h1 class="rmheader">RAMPANT<br/>MANTICORE</h1>
            <h2 class="rmgold prociono">Military Science Fiction & Fantasy Awards</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
